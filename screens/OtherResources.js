...
const config ={
 ...
 class OtherResources extends Component {   
    ...
    render() {
        ...
        const otherresourcesitems = this.state.myIBDs.map(ibd => {
            return(
                <ListItem rowkey="id">
                    <Text style ={styles.listtext}>{ibd.ibdOtherResources} </Text>
                </ListItem>
            )
    ...
    return (
            ...
            <View style={styles.containertwo}>
                ...
                <ScrollView>
                <Text style ={styles.listheading}>Other Resources</Text>
...
export default withNavigation(OtherResources);
